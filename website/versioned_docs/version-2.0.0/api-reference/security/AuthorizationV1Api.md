---
id: AuthorizationV1Api
title: AuthorizationV1Api
sidebar_label: AuthorizationV1Api
sidebar_position: 4
---
# AuthorizationV1Api
...
------------- | ------------- | -------------
[**createNamespacedLocalSubjectAccessReview**](/docs/api-reference/security/AuthorizationV1Api#createNamespacedLocalSubjectAccessReview) | **POST** /apis/authorization.k8s.io/v1/namespaces/{namespace}/localsubjectaccessreviews |
[**createSelfSubjectAccessReview**](/docs/api-reference/security/AuthorizationV1Api#createSelfSubjectAccessReview) | **POST** /apis/authorization.k8s.io/v1/selfsubjectaccessreviews |
[**createSelfSubjectRulesReview**](/docs/api-reference/security/AuthorizationV1Api#createSelfSubjectRulesReview) | **POST** /apis/authorization.k8s.io/v1/selfsubjectrulesreviews |
[**createSubjectAccessReview**](/docs/api-reference/security/AuthorizationV1Api#createSubjectAccessReview) | **POST** /apis/authorization.k8s.io/v1/subjectaccessreviews |
[**getAPIResources**](/docs/api-reference/security/AuthorizationV1Api#getAPIResources) | **GET** /apis/authorization.k8s.io/v1/ |

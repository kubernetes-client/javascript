...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1IngressSpec();
  });
  ...
  describe('V1beta1IngressSpec', function() {
    it('should create an instance of V1beta1IngressSpec', function() {
      ...
      //var instane = new KubernetesJsClient.V1beta1IngressSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1IngressSpec);
    });

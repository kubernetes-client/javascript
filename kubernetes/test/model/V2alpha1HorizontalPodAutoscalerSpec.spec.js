...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2alpha1HorizontalPodAutoscalerSpec();
  });
  ...
  describe('V2alpha1HorizontalPodAutoscalerSpec', function() {
    it('should create an instance of V2alpha1HorizontalPodAutoscalerSpec', function() {
      // uncomment below and update the code to test V2alpha1HorizontalPodAutoscalerSpec
      //var instane = new KubernetesJsClient.V2alpha1HorizontalPodAutoscalerSpec();

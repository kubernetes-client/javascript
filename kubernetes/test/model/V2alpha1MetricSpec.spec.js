...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2alpha1MetricSpec();
  });
  ...
  describe('V2alpha1MetricSpec', function() {
    it('should create an instance of V2alpha1MetricSpec', function() {
      // uncomment below and update the code to test V2alpha1MetricSpec
      //var instane = new KubernetesJsClient.V2alpha1MetricSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V2alpha1MetricSpec);
    });

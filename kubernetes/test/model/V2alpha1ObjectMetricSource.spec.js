...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2alpha1ObjectMetricSource();
  });
  ...
  describe('V2alpha1ObjectMetricSource', function() {
    it('should create an instance of V2alpha1ObjectMetricSource', function() {
      // uncomment below and update the code to test V2alpha1ObjectMetricSource
      //var instane = new KubernetesJsClient.V2alpha1ObjectMetricSource();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1alpha1Subject();
  });
  ...
  describe('V1alpha1Subject', function() {
    it('should create an instance of V1alpha1Subject', function() {
      // uncomment below and update the code to test V1alpha1Subject

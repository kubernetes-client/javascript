...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1IngressList();
  });
  ...
  describe('V1beta1IngressList', function() {
    it('should create an instance of V1beta1IngressList', function() {
      ...
      //var instane = new KubernetesJsClient.V1beta1IngressList();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1IngressList);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1PodSecurityPolicyList();
  });
  ...
  describe('V1beta1PodSecurityPolicyList', function() {
    it('should create an instance of V1beta1PodSecurityPolicyList', function() {
      // uncomment below and update the code to test V1beta1PodSecurityPolicyList

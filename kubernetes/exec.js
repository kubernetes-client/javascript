...
var Exec = (function () {
    ...
    Exec.prototype.exec = function (namespace, podName, containerName, command, stdout, stderr, stdin, tty) {
        return __awaiter(this, void 0, void 0, function () {
            var query, queryStr, path, conn;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        path = "/api/v1/namespaces/" + namespace + "/pods/" + podName + "/exec?" + queryStr;
                        return [4, this.handler.connect(path, null, function (stream, buff) {

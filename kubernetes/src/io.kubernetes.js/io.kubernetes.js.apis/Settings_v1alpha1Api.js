...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('../io.kubernetes.js.models/V1APIResourceList'), require('../io.kubernetes.js.models/V1DeleteOptions'), require('../io.kubernetes.js.models/V1Status'), require('../io.kubernetes.js.models/V1alpha1PodPreset'), require('../io.kubernetes.js.models/V1alpha1PodPresetList'));
  } else {
    // Browser globals (root is window)
    if (!root.KubernetesJsClient) {
      root.KubernetesJsClient = {};
    }
    root.KubernetesJsClient.Settings_v1alpha1Api = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIResourceList, root.KubernetesJsClient.V1DeleteOptions, root.KubernetesJsClient.V1Status, root.KubernetesJsClient.V1alpha1PodPreset, root.KubernetesJsClient.V1alpha1PodPresetList);
  }
}(this, function(ApiClient, V1APIResourceList, V1DeleteOptions, V1Status, V1alpha1PodPreset, V1alpha1PodPresetList) {
  'use strict';

  /**
   * Settings_v1alpha1 service.
   * @module io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new Settings_v1alpha1Api. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~createNamespacedPodPresetCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset} data The data returned by the service call.
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset} body 
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~createNamespacedPodPresetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset}
     */
    this.createNamespacedPodPreset = function(namespace, body, opts, callback) {
      opts = opts || {};
      var postBody = body;
      ...
      var returnType = V1alpha1PodPreset;
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~deleteCollectionNamespacedPodPresetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~deleteCollectionNamespacedPodPresetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Status}
     */
    this.deleteCollectionNamespacedPodPreset = function(namespace, opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~deleteNamespacedPodPresetCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~deleteNamespacedPodPresetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Status}
     */
    this.deleteNamespacedPodPreset = function(name, namespace, body, opts, callback) {
      opts = opts || {};
      var postBody = body;
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~listNamespacedPodPresetCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPresetList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~listNamespacedPodPresetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPresetList}
     */
    this.listNamespacedPodPreset = function(namespace, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      var returnType = V1alpha1PodPresetList;
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~listPodPresetForAllNamespacesCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPresetList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~listPodPresetForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPresetList}
     */
    this.listPodPresetForAllNamespaces = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~patchNamespacedPodPresetCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~patchNamespacedPodPresetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset}
     */
    this.patchNamespacedPodPreset = function(name, namespace, body, opts, callback) {
      opts = opts || {};
      var postBody = body;
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~readNamespacedPodPresetCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~readNamespacedPodPresetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset}
     */
    this.readNamespacedPodPreset = function(name, namespace, opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~replaceNamespacedPodPresetCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Settings_v1alpha1Api~replaceNamespacedPodPresetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PodPreset}
     */
    this.replaceNamespacedPodPreset = function(name, namespace, body, opts, callback) {
      opts = opts || {};
      var postBody = body;

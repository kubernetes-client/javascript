...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('../io.kubernetes.js.models/V1APIResourceList'), require('../io.kubernetes.js.models/V1DeleteOptions'), require('../io.kubernetes.js.models/V1Status'), require('../io.kubernetes.js.models/V1beta1StorageClass'), require('../io.kubernetes.js.models/V1beta1StorageClassList'));
  } else {
    // Browser globals (root is window)
    if (!root.KubernetesJsClient) {
      root.KubernetesJsClient = {};
    }
    root.KubernetesJsClient.Storage_v1beta1Api = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIResourceList, root.KubernetesJsClient.V1DeleteOptions, root.KubernetesJsClient.V1Status, root.KubernetesJsClient.V1beta1StorageClass, root.KubernetesJsClient.V1beta1StorageClassList);
  }
}(this, function(ApiClient, V1APIResourceList, V1DeleteOptions, V1Status, V1beta1StorageClass, V1beta1StorageClassList) {
  'use strict';

  /**
   * Storage_v1beta1 service.
   * @module io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new Storage_v1beta1Api. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~createStorageClassCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~createStorageClassCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~deleteCollectionStorageClassCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~deleteCollectionStorageClassCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~deleteStorageClassCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~deleteStorageClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Status}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~listStorageClassCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~listStorageClassCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~patchStorageClassCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1StorageClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~patchStorageClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1beta1StorageClass}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~readStorageClassCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1StorageClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~readStorageClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1beta1StorageClass}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~replaceStorageClassCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1StorageClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/Storage_v1beta1Api~replaceStorageClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1beta1StorageClass}
     */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.BatchApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
  ...
  /**
   * Batch service.
   * @module io.kubernetes.js/io.kubernetes.js.apis/BatchApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new BatchApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/BatchApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.StorageApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
  ...
  /**
   * Storage service.
   * @module io.kubernetes.js/io.kubernetes.js.apis/StorageApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new StorageApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/StorageApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/StorageApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/StorageApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

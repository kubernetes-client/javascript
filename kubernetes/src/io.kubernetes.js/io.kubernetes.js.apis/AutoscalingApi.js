...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.AutoscalingApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
  ...
  /**
   * Autoscaling service.
   * @module io.kubernetes.js/io.kubernetes.js.apis/AutoscalingApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new AutoscalingApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/AutoscalingApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/AutoscalingApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/AutoscalingApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.RbacAuthorizationApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.apis/RbacAuthorizationApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new RbacAuthorizationApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/RbacAuthorizationApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/RbacAuthorizationApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/RbacAuthorizationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.AuthorizationApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.apis/AuthorizationApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new AuthorizationApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/AuthorizationApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/AuthorizationApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/AuthorizationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.ExtensionsApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
  ...
  /**
   * Extensions service.
   * @module io.kubernetes.js/io.kubernetes.js.apis/ExtensionsApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new ExtensionsApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/ExtensionsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/ExtensionsApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/ExtensionsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

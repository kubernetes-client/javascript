...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.PolicyApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
  ...
  /**
   * Policy service.
   * @module io.kubernetes.js/io.kubernetes.js.apis/PolicyApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new PolicyApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/PolicyApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/PolicyApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/PolicyApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

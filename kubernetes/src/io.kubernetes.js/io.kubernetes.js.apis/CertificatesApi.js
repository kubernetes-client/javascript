...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.CertificatesApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.apis/CertificatesApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new CertificatesApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/CertificatesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/CertificatesApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/CertificatesApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

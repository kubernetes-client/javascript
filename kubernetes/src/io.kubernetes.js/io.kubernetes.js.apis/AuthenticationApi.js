...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.AuthenticationApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1APIGroup);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.apis/AuthenticationApi
   * @version 1.0.0-snapshot
   */

  /**
   * Constructs a new AuthenticationApi. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/AuthenticationApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/AuthenticationApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/AuthenticationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1PersistentVolume>} List of persistent volumes. More info: http://kubernetes.io/docs/user-guide/persistent-volumes
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1PersistentVolumeList} The populated <code>V1PersistentVolumeList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1PersistentVolume>} items
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.V1beta1IngressStatus = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1LoadBalancerStatus);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V1beta1IngressStatus
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1IngressStatus} The populated <code>V1beta1IngressStatus</code> instance.
   */

...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1PodTemplate>} List of pod templates
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1PodTemplateList} The populated <code>V1PodTemplateList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1PodTemplate>} items
   */

...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>V1beta1PodSecurityPolicyList</code>.
   * Pod Security Policy List is a list of PodSecurityPolicy objects.
   * @alias module:io.kubernetes.js/io.kubernetes.js.models/V1beta1PodSecurityPolicyList
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1PodSecurityPolicy>} Items is a list of schema objects.
   */
  ...
  /**
   * Constructs a <code>V1beta1PodSecurityPolicyList</code> from a plain JavaScript object, optionally creating a new instance.
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1PodSecurityPolicyList} The populated <code>V1beta1PodSecurityPolicyList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1PodSecurityPolicy>} items
   */

...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Job>} Items is the list of Job.
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1JobList} The populated <code>V1JobList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Job>} items
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.V1beta1ReplicaSetSpec = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1LabelSelector, root.KubernetesJsClient.V1PodTemplateSpec);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetSpec
   ...
   * @alias module:io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetSpec
   * @class
   */
   ...
   * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetSpec} obj Optional instance to populate.
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetSpec} The populated <code>V1beta1ReplicaSetSpec</code> instance.
   */

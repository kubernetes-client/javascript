...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.V1ConfigMapProjection = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1KeyToPath);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V1ConfigMapProjection
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1ConfigMapProjection} The populated <code>V1ConfigMapProjection</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['io.kubernetes.js/ApiClient', 'io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetCondition'], factory);
    ...
    root.KubernetesJsClient.V1beta1ReplicaSetStatus = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1beta1ReplicaSetCondition);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetStatus
   ...
   * @alias module:io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetStatus
   * @class
   ...
   * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetStatus} obj Optional instance to populate.
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetStatus} The populated <code>V1beta1ReplicaSetStatus</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1ReplicaSetCondition>} conditions
   */

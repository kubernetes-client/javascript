...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.V1ConfigMap = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1ObjectMeta);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V1ConfigMap
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1ConfigMap} The populated <code>V1ConfigMap</code> instance.
   */

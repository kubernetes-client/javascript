...
(function(root, factory) {
   ...
   * @class
   * @param rules {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1PolicyRule>} Rules holds all the PolicyRules for this ClusterRole
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1alpha1ClusterRole} The populated <code>V1alpha1ClusterRole</code> instance.
   */

...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Secret>} Items is a list of secret objects. More info: http://kubernetes.io/docs/user-guide/secrets
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1SecretList} The populated <code>V1SecretList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Secret>} items
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['io.kubernetes.js/ApiClient', 'io.kubernetes.js/io.kubernetes.js.models/V1beta1HTTPIngressRuleValue'], factory);
    ...
    root.KubernetesJsClient.V1beta1IngressRule = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1beta1HTTPIngressRuleValue);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V1beta1IngressRule
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1IngressRule} The populated <code>V1beta1IngressRule</code> instance.
   */

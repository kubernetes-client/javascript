...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1ReplicationController>} List of replication controllers. More info: http://kubernetes.io/docs/user-guide/replication-controller
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1ReplicationControllerList} The populated <code>V1ReplicationControllerList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1ReplicationController>} items
   */

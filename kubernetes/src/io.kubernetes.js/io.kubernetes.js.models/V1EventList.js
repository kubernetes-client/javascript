...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Event>} List of events
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1EventList} The populated <code>V1EventList</code> instance.
   */
  ...
  /**
   * List of events
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Event>} items
   */

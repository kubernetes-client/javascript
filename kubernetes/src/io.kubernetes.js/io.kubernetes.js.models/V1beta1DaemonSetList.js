...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1DaemonSet>} A list of daemon sets.
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1DaemonSetList} The populated <code>V1beta1DaemonSetList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1DaemonSet>} items
   */

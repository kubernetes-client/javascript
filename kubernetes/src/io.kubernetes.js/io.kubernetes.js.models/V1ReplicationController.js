...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['io.kubernetes.js/ApiClient', 'io.kubernetes.js/io.kubernetes.js.models/V1ObjectMeta', 'io.kubernetes.js/io.kubernetes.js.models/V1ReplicationControllerSpec', 'io.kubernetes.js/io.kubernetes.js.models/V1ReplicationControllerStatus'], factory);
    ...
    root.KubernetesJsClient.V1ReplicationController = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.V1ObjectMeta, root.KubernetesJsClient.V1ReplicationControllerSpec, root.KubernetesJsClient.V1ReplicationControllerStatus);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V1ReplicationController
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1ReplicationController} The populated <code>V1ReplicationController</code> instance.
   */

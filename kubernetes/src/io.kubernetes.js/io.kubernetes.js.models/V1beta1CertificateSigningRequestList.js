...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1CertificateSigningRequest>} 
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1CertificateSigningRequestList} The populated <code>V1beta1CertificateSigningRequestList</code> instance.
   */
  ...
  /**
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1CertificateSigningRequest>} items
   */

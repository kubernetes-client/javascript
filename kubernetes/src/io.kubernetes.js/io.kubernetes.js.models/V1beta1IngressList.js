...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1Ingress>} Items is the list of Ingress.
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1IngressList} The populated <code>V1beta1IngressList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1Ingress>} items
   */

...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Node>} List of nodes
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1NodeList} The populated <code>V1NodeList</code> instance.
   */
  ...
  /**
   * List of nodes
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Node>} items
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./ExtensionsV1beta1DeploymentStrategy'), require('./ExtensionsV1beta1RollbackConfig'), require('./V1LabelSelector'), require('./V1PodTemplateSpec'));
  } else {
    // Browser globals (root is window)
    if (!root.KubernetesJsClient) {
      root.KubernetesJsClient = {};
    }
    root.KubernetesJsClient.ExtensionsV1beta1DeploymentSpec = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.ExtensionsV1beta1DeploymentStrategy, root.KubernetesJsClient.ExtensionsV1beta1RollbackConfig, root.KubernetesJsClient.V1LabelSelector, root.KubernetesJsClient.V1PodTemplateSpec);
  }
}(this, function(ApiClient, ExtensionsV1beta1DeploymentStrategy, ExtensionsV1beta1RollbackConfig, V1LabelSelector, V1PodTemplateSpec) {
  'use strict';
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/ExtensionsV1beta1DeploymentSpec
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/ExtensionsV1beta1DeploymentSpec} The populated <code>ExtensionsV1beta1DeploymentSpec</code> instance.
   */

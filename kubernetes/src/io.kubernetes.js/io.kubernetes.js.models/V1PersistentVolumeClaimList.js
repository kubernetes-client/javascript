...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1PersistentVolumeClaim>} A list of persistent volume claims. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1PersistentVolumeClaimList} The populated <code>V1PersistentVolumeClaimList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1PersistentVolumeClaim>} items
   */

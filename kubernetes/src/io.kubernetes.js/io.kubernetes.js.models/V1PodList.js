...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Pod>} List of pods. More info: http://kubernetes.io/docs/user-guide/pods
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1PodList} The populated <code>V1PodList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Pod>} items
   */

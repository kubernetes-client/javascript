...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Namespace>} Items is the list of Namespace objects in the list. More info: http://kubernetes.io/docs/user-guide/namespaces
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1NamespaceList} The populated <code>V1NamespaceList</code> instance.
   */
   ...
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1Namespace>} items
   */

...
(function(root, factory) {
   ...
   * @class
   * @param items {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1PodDisruptionBudget>} 
   */
   ...
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1PodDisruptionBudgetList} The populated <code>V1beta1PodDisruptionBudgetList</code> instance.
   */
  ...
  /**
   * @member {Array.<module:io.kubernetes.js/io.kubernetes.js.models/V1beta1PodDisruptionBudget>} items
   */

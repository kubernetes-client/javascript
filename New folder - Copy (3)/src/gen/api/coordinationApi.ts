...
export enum CoordinationApiApiKeys {
    BearerToken,
}
...
export class CoordinationApi {
    ...
    public setApiKey(key: CoordinationApiApiKeys, value: string) {
        (this.authentications as any)[CoordinationApiApiKeys[key]].apiKey = value;
    }

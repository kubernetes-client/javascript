...
goog.provide('proto.k8s.io.api.core.v1.NodeCondition');
...
proto.k8s.io.api.core.v1.NodeCondition.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lastheartbeattime: (f = msg.getLastheartbeattime()) && proto.k8s.io.apimachinery.pkg.apis.meta.v1.Time.toObject(includeInstance, f),

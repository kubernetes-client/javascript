...
goog.provide('proto.k8s.io.api.core.v1.GitRepoVolumeSource');
...
proto.k8s.io.api.core.v1.GitRepoVolumeSource.toObject = function(includeInstance, msg) {
  var f, obj = {
    repository: jspb.Message.getField(msg, 1),
    revision: jspb.Message.getField(msg, 2),
    directory: jspb.Message.getField(msg, 3)
  };

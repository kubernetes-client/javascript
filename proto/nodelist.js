...
goog.provide('proto.k8s.io.api.core.v1.NodeList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.Node');
...
proto.k8s.io.api.core.v1.NodeList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.Node.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.NodeList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.Node.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.NodeList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.Node>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.Node, 2));
};

...
goog.provide('proto.k8s.io.api.core.v1.ComponentStatusList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ComponentStatus');
...
proto.k8s.io.api.core.v1.ComponentStatusList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.ComponentStatus.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.ComponentStatusList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.ComponentStatus.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ComponentStatusList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.ComponentStatus>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.ComponentStatus, 2));
};

...
goog.provide('proto.k8s.io.api.core.v1.Endpoints');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.EndpointSubset');
...
proto.k8s.io.api.core.v1.Endpoints.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    subsetsList: jspb.Message.toObjectList(msg.getSubsetsList(),
    proto.k8s.io.api.core.v1.EndpointSubset.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.Endpoints.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.EndpointSubset.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.Endpoints.prototype.getSubsetsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.EndpointSubset>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.EndpointSubset, 2));
};

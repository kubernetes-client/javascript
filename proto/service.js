...
goog.provide('proto.k8s.io.api.core.v1.Service');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ServiceSpec');
goog.require('proto.k8s.io.api.core.v1.ServiceStatus');
...
proto.k8s.io.api.core.v1.Service.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.ServiceSpec.serializeBinaryToWriter
    );
  }
  f = message.getStatus();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.k8s.io.api.core.v1.ServiceStatus.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.Service.prototype.getSpec = function() {
  return /** @type{?proto.k8s.io.api.core.v1.ServiceSpec} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.ServiceSpec, 2));
};
...
proto.k8s.io.api.core.v1.Service.prototype.getStatus = function() {
  return /** @type{?proto.k8s.io.api.core.v1.ServiceStatus} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.ServiceStatus, 3));
};

...
goog.provide('proto.k8s.io.api.core.v1.List');
...
proto.k8s.io.api.core.v1.List.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.apimachinery.pkg.runtime.RawExtension.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.List.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.apimachinery.pkg.runtime.RawExtension>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.apimachinery.pkg.runtime.RawExtension, 2));
};

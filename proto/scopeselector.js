...
goog.provide('proto.k8s.io.api.core.v1.ScopeSelector');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ScopedResourceSelectorRequirement');
...
proto.k8s.io.api.core.v1.ScopeSelector.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.ScopedResourceSelectorRequirement.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.ScopeSelector.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.k8s.io.api.core.v1.ScopedResourceSelectorRequirement.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ScopeSelector.prototype.getMatchexpressionsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.ScopedResourceSelectorRequirement>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.ScopedResourceSelectorRequirement, 1));
};

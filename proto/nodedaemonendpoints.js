...
goog.provide('proto.k8s.io.api.core.v1.NodeDaemonEndpoints');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.DaemonEndpoint');
...
proto.k8s.io.api.core.v1.NodeDaemonEndpoints.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.k8s.io.api.core.v1.DaemonEndpoint.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.NodeDaemonEndpoints.prototype.getKubeletendpoint = function() {
  return /** @type{?proto.k8s.io.api.core.v1.DaemonEndpoint} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.DaemonEndpoint, 1));
};
...
proto.k8s.io.api.core.v1.NodeDaemonEndpoints.prototype.clearKubeletendpoint = function() {
  this.setKubeletendpoint(undefined);
};

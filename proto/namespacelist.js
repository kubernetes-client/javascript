...
goog.provide('proto.k8s.io.api.core.v1.NamespaceList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.Namespace');
...
proto.k8s.io.api.core.v1.NamespaceList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.Namespace.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.NamespaceList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.Namespace.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.NamespaceList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.Namespace>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.Namespace, 2));
};

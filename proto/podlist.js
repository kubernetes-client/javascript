...
goog.provide('proto.k8s.io.api.core.v1.PodList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.Pod');
...
proto.k8s.io.api.core.v1.PodList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.Pod.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.PodList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.Pod.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.PodList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.Pod>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.Pod, 2));
};

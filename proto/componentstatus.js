...
goog.provide('proto.k8s.io.api.core.v1.ComponentStatus');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ComponentCondition');
...
proto.k8s.io.api.core.v1.ComponentStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.ComponentCondition.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.ComponentStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.ComponentCondition.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ComponentStatus.prototype.getConditionsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.ComponentCondition>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.ComponentCondition, 2));
};

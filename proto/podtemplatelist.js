...
goog.provide('proto.k8s.io.api.core.v1.PodTemplateList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.PodTemplate');
...
proto.k8s.io.api.core.v1.PodTemplateList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.PodTemplate.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.PodTemplateList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.PodTemplate.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.PodTemplateList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.PodTemplate>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.PodTemplate, 2));
};

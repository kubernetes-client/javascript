...
goog.provide('proto.k8s.io.api.core.v1.ServiceAccountTokenProjection');
...
proto.k8s.io.api.core.v1.ServiceAccountTokenProjection.toObject = function(includeInstance, msg) {
  var f, obj = {
    audience: jspb.Message.getField(msg, 1),
    expirationseconds: jspb.Message.getField(msg, 2),
    path: jspb.Message.getField(msg, 3)
  };

...
goog.provide('proto.k8s.io.api.core.v1.ServiceAccountList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ServiceAccount');
...
proto.k8s.io.api.core.v1.ServiceAccountList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.ServiceAccount.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.ServiceAccountList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.ServiceAccount.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ServiceAccountList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.ServiceAccount>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.ServiceAccount, 2));
};

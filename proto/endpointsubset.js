...
goog.provide('proto.k8s.io.api.core.v1.EndpointSubset');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.EndpointAddress');
goog.require('proto.k8s.io.api.core.v1.EndpointPort');
...
proto.k8s.io.api.core.v1.EndpointSubset.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.EndpointAddress.toObject, includeInstance),
    notreadyaddressesList: jspb.Message.toObjectList(msg.getNotreadyaddressesList(),
    proto.k8s.io.api.core.v1.EndpointAddress.toObject, includeInstance),
    portsList: jspb.Message.toObjectList(msg.getPortsList(),
    proto.k8s.io.api.core.v1.EndpointPort.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.EndpointSubset.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.k8s.io.api.core.v1.EndpointAddress.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.k8s.io.api.core.v1.EndpointPort.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.EndpointSubset.prototype.getAddressesList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.EndpointAddress>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.EndpointAddress, 1));
};
...
proto.k8s.io.api.core.v1.EndpointSubset.prototype.getNotreadyaddressesList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.EndpointAddress>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.EndpointAddress, 2));
};
...
proto.k8s.io.api.core.v1.EndpointSubset.prototype.getPortsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.EndpointPort>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.EndpointPort, 3));
};

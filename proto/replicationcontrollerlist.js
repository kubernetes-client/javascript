...
goog.provide('proto.k8s.io.api.core.v1.ReplicationControllerList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ReplicationController');
...
proto.k8s.io.api.core.v1.ReplicationControllerList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.ReplicationController.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.ReplicationControllerList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.ReplicationController.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ReplicationControllerList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.ReplicationController>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.ReplicationController, 2));
};

...
goog.provide('proto.k8s.io.api.core.v1.LimitRangeSpec');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.LimitRangeItem');
...
proto.k8s.io.api.core.v1.LimitRangeSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.LimitRangeItem.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.LimitRangeSpec.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.k8s.io.api.core.v1.LimitRangeItem.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.LimitRangeSpec.prototype.getLimitsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.LimitRangeItem>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.LimitRangeItem, 1));
};

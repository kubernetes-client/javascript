...
goog.provide('proto.k8s.io.api.core.v1.PreferredSchedulingTerm');
...
proto.k8s.io.api.core.v1.PreferredSchedulingTerm.prototype.getPreference = function() {
  return /** @type{?proto.k8s.io.api.core.v1.NodeSelectorTerm} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.NodeSelectorTerm, 2));
};

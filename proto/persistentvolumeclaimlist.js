...
goog.provide('proto.k8s.io.api.core.v1.PersistentVolumeClaimList');
...
proto.k8s.io.api.core.v1.PersistentVolumeClaimList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.PersistentVolumeClaim>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.PersistentVolumeClaim, 2));
};

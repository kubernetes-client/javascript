...
goog.provide('proto.k8s.io.api.core.v1.ResourceQuota');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ResourceQuotaSpec');
goog.require('proto.k8s.io.api.core.v1.ResourceQuotaStatus');
...
proto.k8s.io.api.core.v1.ResourceQuota.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.ResourceQuotaSpec.serializeBinaryToWriter
    );
  }
  f = message.getStatus();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.k8s.io.api.core.v1.ResourceQuotaStatus.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ResourceQuota.prototype.getSpec = function() {
  return /** @type{?proto.k8s.io.api.core.v1.ResourceQuotaSpec} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.ResourceQuotaSpec, 2));
};
...
proto.k8s.io.api.core.v1.ResourceQuota.prototype.getStatus = function() {
  return /** @type{?proto.k8s.io.api.core.v1.ResourceQuotaStatus} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.ResourceQuotaStatus, 3));
};

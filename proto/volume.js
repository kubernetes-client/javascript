...
goog.provide('proto.k8s.io.api.core.v1.Volume');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.VolumeSource');
...
proto.k8s.io.api.core.v1.Volume.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.VolumeSource.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.Volume.prototype.getVolumesource = function() {
  return /** @type{?proto.k8s.io.api.core.v1.VolumeSource} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.VolumeSource, 2));
};
...
proto.k8s.io.api.core.v1.Volume.prototype.clearVolumesource = function() {
  this.setVolumesource(undefined);
};

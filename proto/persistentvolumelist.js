...
goog.provide('proto.k8s.io.api.core.v1.PersistentVolumeList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.PersistentVolume');
...
proto.k8s.io.api.core.v1.PersistentVolumeList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.PersistentVolume.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.PersistentVolumeList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.PersistentVolume.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.PersistentVolumeList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.PersistentVolume>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.PersistentVolume, 2));
};

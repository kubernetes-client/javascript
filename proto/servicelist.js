...
goog.provide('proto.k8s.io.api.core.v1.ServiceList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.Service');
...
proto.k8s.io.api.core.v1.ServiceList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.Service.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.ServiceList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.Service.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ServiceList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.Service>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.Service, 2));
};

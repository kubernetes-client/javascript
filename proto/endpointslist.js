...
goog.provide('proto.k8s.io.api.core.v1.EndpointsList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.Endpoints');
...
proto.k8s.io.api.core.v1.EndpointsList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.Endpoints.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.EndpointsList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.Endpoints.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.EndpointsList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.Endpoints>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.Endpoints, 2));
};

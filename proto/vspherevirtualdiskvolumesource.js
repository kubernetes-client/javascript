...
goog.provide('proto.k8s.io.api.core.v1.VsphereVirtualDiskVolumeSource');
...
proto.k8s.io.api.core.v1.VsphereVirtualDiskVolumeSource.toObject = function(includeInstance, msg) {
  var f, obj = {
    volumepath: jspb.Message.getField(msg, 1),
    fstype: jspb.Message.getField(msg, 2),
    storagepolicyname: jspb.Message.getField(msg, 3),
    storagepolicyid: jspb.Message.getField(msg, 4)
  };

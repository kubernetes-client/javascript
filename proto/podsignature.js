...
goog.provide('proto.k8s.io.api.core.v1.PodSignature');
...
proto.k8s.io.api.core.v1.PodSignature.toObject = function(includeInstance, msg) {
  var f, obj = {
    podcontroller: (f = msg.getPodcontroller()) && proto.k8s.io.apimachinery.pkg.apis.meta.v1.OwnerReference.toObject(includeInstance, f)
  };
...
proto.k8s.io.api.core.v1.PodSignature.prototype.getPodcontroller = function() {
  return /** @type{?proto.k8s.io.apimachinery.pkg.apis.meta.v1.OwnerReference} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.apimachinery.pkg.apis.meta.v1.OwnerReference, 1));
};
...
proto.k8s.io.api.core.v1.PodSignature.prototype.clearPodcontroller = function() {
  this.setPodcontroller(undefined);
};

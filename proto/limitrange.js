...
goog.provide('proto.k8s.io.api.core.v1.LimitRange');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.LimitRangeSpec');
...
proto.k8s.io.api.core.v1.LimitRange.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.LimitRangeSpec.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.LimitRange.prototype.getSpec = function() {
  return /** @type{?proto.k8s.io.api.core.v1.LimitRangeSpec} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.LimitRangeSpec, 2));
};

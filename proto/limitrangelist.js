...
goog.provide('proto.k8s.io.api.core.v1.LimitRangeList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.LimitRange');
...
proto.k8s.io.api.core.v1.LimitRangeList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.LimitRange.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.LimitRangeList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.LimitRange.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.LimitRangeList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.LimitRange>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.LimitRange, 2));
};

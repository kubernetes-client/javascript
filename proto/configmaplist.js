...
goog.provide('proto.k8s.io.api.core.v1.ConfigMapList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ConfigMap');
...
proto.k8s.io.api.core.v1.ConfigMapList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.ConfigMap.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.ConfigMapList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.ConfigMap.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ConfigMapList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.ConfigMap>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.ConfigMap, 2));
};

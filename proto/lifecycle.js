...
goog.provide('proto.k8s.io.api.core.v1.Lifecycle');
...
proto.k8s.io.api.core.v1.Lifecycle.prototype.getPrestop = function() {
  return /** @type{?proto.k8s.io.api.core.v1.Handler} */ (
    jspb.Message.getWrapperField(this, proto.k8s.io.api.core.v1.Handler, 2));
};

...
goog.provide('proto.k8s.io.api.core.v1.TopologySelectorTerm');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.TopologySelectorLabelRequirement');
...
proto.k8s.io.api.core.v1.TopologySelectorTerm.toObject = function(includeInstance, msg) {
  var f, obj = {
    matchlabelexpressionsList: jspb.Message.toObjectList(msg.getMatchlabelexpressionsList(),
    proto.k8s.io.api.core.v1.TopologySelectorLabelRequirement.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.TopologySelectorTerm.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.k8s.io.api.core.v1.TopologySelectorLabelRequirement.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.TopologySelectorTerm.prototype.getMatchlabelexpressionsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.TopologySelectorLabelRequirement>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.TopologySelectorLabelRequirement, 1));
};
...
proto.k8s.io.api.core.v1.TopologySelectorTerm.prototype.clearMatchlabelexpressionsList = function() {
  this.setMatchlabelexpressionsList([]);
};

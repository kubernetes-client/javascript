...
goog.provide('proto.k8s.io.api.core.v1.ResourceQuotaList');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.k8s.io.api.core.v1.ResourceQuota');
...
proto.k8s.io.api.core.v1.ResourceQuotaList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.k8s.io.api.core.v1.ResourceQuota.toObject, includeInstance)
  };
...
proto.k8s.io.api.core.v1.ResourceQuotaList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.k8s.io.api.core.v1.ResourceQuota.serializeBinaryToWriter
    );
  }
};
...
proto.k8s.io.api.core.v1.ResourceQuotaList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.core.v1.ResourceQuota>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.k8s.io.api.core.v1.ResourceQuota, 2));
};

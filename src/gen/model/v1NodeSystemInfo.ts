...
export class V1NodeSystemInfo {
    ...
    */
    ...
    /**
    * MachineID reported by the node. For unique machine identification in the cluster this field is preferred. Learn more from man(5) machine-id: https://man7.org/linux/man-pages/man5/machine-id.5.html
    */
    'machineID': string;
    /**

...
let body:.SchedulingV1ApiCreatePriorityClassRequest = {
  // V1PriorityClass
  body: {
...
let body:.SchedulingV1ApiDeleteCollectionPriorityClassRequest = {
  // string | If \'true\', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
let body:.SchedulingV1ApiDeletePriorityClassRequest = {
...
let body:.SchedulingV1ApiListPriorityClassRequest = {
  // string | If \'true\', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
let body:.SchedulingV1ApiPatchPriorityClassRequest = {
  // string | name of the PriorityClass
  name: "name_example",
  // any
  body: {},
...
let body:.SchedulingV1ApiReadPriorityClassRequest = {
  // string | name of the PriorityClass
  name: "name_example",
  // string | If \'true\', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
let body:.SchedulingV1ApiReplacePriorityClassRequest = {
  // string | name of the PriorityClass
  name: "name_example",
  // V1PriorityClass
  body: {

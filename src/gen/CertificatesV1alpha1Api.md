...
let body:.CertificatesV1alpha1ApiCreateClusterTrustBundleRequest = {
...
apiInstance.createClusterTrustBundle(body).then((data:any) => {
...
let body:.CertificatesV1alpha1ApiDeleteClusterTrustBundleRequest = {
  // string | name of the ClusterTrustBundle
  name: "name_example",
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
  // string | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
...
apiInstance.deleteClusterTrustBundle(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.CertificatesV1alpha1ApiDeleteCollectionClusterTrustBundleRequest = {
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
apiInstance.deleteCollectionClusterTrustBundle(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.CertificatesV1alpha1ApiListClusterTrustBundleRequest = {
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
apiInstance.listClusterTrustBundle(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.CertificatesV1alpha1ApiPatchClusterTrustBundleRequest = {
  // string | name of the ClusterTrustBundle
  name: "name_example",
  // any
  body: {},
...
apiInstance.patchClusterTrustBundle(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.CertificatesV1alpha1ApiReadClusterTrustBundleRequest = {
  // string | name of the ClusterTrustBundle
  name: "name_example",
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
apiInstance.readClusterTrustBundle(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.CertificatesV1alpha1ApiReplaceClusterTrustBundleRequest = {
  // string | name of the ClusterTrustBundle
  name: "name_example",
  // V1alpha1ClusterTrustBundle
  body: {
...
apiInstance.replaceClusterTrustBundle(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```

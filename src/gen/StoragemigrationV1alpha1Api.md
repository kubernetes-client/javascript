...
let body:.StoragemigrationV1alpha1ApiCreateStorageVersionMigrationRequest = {
...
apiInstance.createStorageVersionMigration(body).then((data:any) => {
...
let body:.StoragemigrationV1alpha1ApiDeleteCollectionStorageVersionMigrationRequest = {
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.deleteCollectionStorageVersionMigration(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StoragemigrationV1alpha1ApiDeleteStorageVersionMigrationRequest = {
  // string | name of the StorageVersionMigration
  name: "name_example",
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
  // string | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
...
apiInstance.deleteStorageVersionMigration(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StoragemigrationV1alpha1ApiListStorageVersionMigrationRequest = {
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.listStorageVersionMigration(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StoragemigrationV1alpha1ApiPatchStorageVersionMigrationRequest = {
  // string | name of the StorageVersionMigration
  name: "name_example",
  // any
  body: {},
...
apiInstance.patchStorageVersionMigration(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StoragemigrationV1alpha1ApiPatchStorageVersionMigrationStatusRequest = {
  // string | name of the StorageVersionMigration
  name: "name_example",
  // any
  body: {},
...
apiInstance.patchStorageVersionMigrationStatus(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StoragemigrationV1alpha1ApiReadStorageVersionMigrationRequest = {
  // string | name of the StorageVersionMigration
  name: "name_example",
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.readStorageVersionMigration(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StoragemigrationV1alpha1ApiReadStorageVersionMigrationStatusRequest = {
  // string | name of the StorageVersionMigration
  name: "name_example",
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.readStorageVersionMigrationStatus(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StoragemigrationV1alpha1ApiReplaceStorageVersionMigrationRequest = {
  // string | name of the StorageVersionMigration
  name: "name_example",
  // V1alpha1StorageVersionMigration
  body: {
...
apiInstance.replaceStorageVersionMigration(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StoragemigrationV1alpha1ApiReplaceStorageVersionMigrationStatusRequest = {
  // string | name of the StorageVersionMigration
  name: "name_example",
  // V1alpha1StorageVersionMigration
  body: {
...
apiInstance.replaceStorageVersionMigrationStatus(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```

...
export enum ApiextensionsApiApiKeys {
    BearerToken,
}
...
export class ApiextensionsApi {
    ...
    public setApiKey(key: ApiextensionsApiApiKeys, value: string) {
        (this.authentications as any)[ApiextensionsApiApiKeys[key]].apiKey = value;
    }

...
export enum AuditregistrationApiApiKeys {
    BearerToken,
}

export class AuditregistrationApi {
    ...
    public setApiKey(key: AuditregistrationApiApiKeys, value: string) {
        (this.authentications as any)[AuditregistrationApiApiKeys[key]].apiKey = value;
    }

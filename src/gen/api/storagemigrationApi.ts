...
export enum StoragemigrationApiApiKeys {
    BearerToken,
}

export class StoragemigrationApi {
    ...
    public setApiKey(key: StoragemigrationApiApiKeys, value: string) {
        (this.authentications as any)[StoragemigrationApiApiKeys[key]].apiKey = value;
    }

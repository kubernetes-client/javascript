...
export enum SchedulingApiApiKeys {
    BearerToken,
}
...
export class SchedulingApi {
    ...
    public setApiKey(key: SchedulingApiApiKeys, value: string) {
        (this.authentications as any)[SchedulingApiApiKeys[key]].apiKey = value;
    }

...
export enum InternalApiserverApiApiKeys {
    BearerToken,
}
...
export class InternalApiserverApi {
    ...
    public setApiKey(key: InternalApiserverApiApiKeys, value: string) {
        (this.authentications as any)[InternalApiserverApiApiKeys[key]].apiKey = value;
    }

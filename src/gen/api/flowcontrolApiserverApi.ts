...
export enum FlowcontrolApiserverApiApiKeys {
    BearerToken,
}
...
export class FlowcontrolApiserverApi {
    ...
    public setApiKey(key: FlowcontrolApiserverApiApiKeys, value: string) {
        (this.authentications as any)[FlowcontrolApiserverApiApiKeys[key]].apiKey = value;
    }

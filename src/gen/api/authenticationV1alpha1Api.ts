...
export enum AuthenticationV1alpha1ApiApiKeys {
    BearerToken,
}
...
export class AuthenticationV1alpha1Api {
    ...
    public setApiKey(key: AuthenticationV1alpha1ApiApiKeys, value: string) {
        (this.authentications as any)[AuthenticationV1alpha1ApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createSelfSubjectReview (body: V1alpha1SelfSubjectReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1alpha1SelfSubjectReview;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(body, "V1alpha1SelfSubjectReview")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1alpha1SelfSubjectReview;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "V1alpha1SelfSubjectReview");

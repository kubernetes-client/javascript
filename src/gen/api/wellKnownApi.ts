...
export enum WellKnownApiApiKeys {
    BearerToken,
}
...
export class WellKnownApi {
    ...
    public setApiKey(key: WellKnownApiApiKeys, value: string) {
        (this.authentications as any)[WellKnownApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getServiceAccountIssuerOpenIDConfiguration (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {

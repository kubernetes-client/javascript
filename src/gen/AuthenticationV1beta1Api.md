...
> V1beta1SelfSubjectReview createSelfSubjectReview(body)
...
```typescript
import { createConfiguration, AuthenticationV1beta1Api } from '';
import type { AuthenticationV1beta1ApiCreateSelfSubjectReviewRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AuthenticationV1beta1Api(configuration);

const request: AuthenticationV1beta1ApiCreateSelfSubjectReviewRequest = {

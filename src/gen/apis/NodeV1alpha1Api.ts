 ...
 * no description
 */
export class NodeV1alpha1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createRuntimeClass(body: V1alpha1RuntimeClass, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("NodeV1alpha1Api", "createRuntimeClass", "body");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(body, "V1alpha1RuntimeClass", ""),
            contentType
        );
    ...
    public async deleteRuntimeClass(name: string, pretty?: string, dryRun?: string, gracePeriodSeconds?: number, orphanDependents?: boolean, propagationPolicy?: string, body?: V1DeleteOptions, _options?: Configuration): Promise<RequestContext> {
        ...
        if (name === null || name === undefined) {
            throw new RequiredError("NodeV1alpha1Api", "deleteRuntimeClass", "name");
        }
    ...
    public async patchRuntimeClass(name: string, body: any, pretty?: string, dryRun?: string, fieldManager?: string, force?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("NodeV1alpha1Api", "patchRuntimeClass", "name");
        }


        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("NodeV1alpha1Api", "patchRuntimeClass", "body");
        }
    ...
    public async readRuntimeClass(name: string, pretty?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("NodeV1alpha1Api", "readRuntimeClass", "name");
        }
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceRuntimeClass(name: string, body: V1alpha1RuntimeClass, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("NodeV1alpha1Api", "replaceRuntimeClass", "name");
        }


        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("NodeV1alpha1Api", "replaceRuntimeClass", "body");
        }
...
export class NodeV1alpha1ApiResponseProcessor {

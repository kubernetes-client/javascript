...
export class AdmissionregistrationV1alpha1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param body 
     */
    public async deleteCollectionValidatingAdmissionPolicyBinding(pretty?: string, _continue?: string, dryRun?: string, fieldSelector?: string, gracePeriodSeconds?: number, labelSelector?: string, limit?: number, orphanDependents?: boolean, propagationPolicy?: string, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, body?: V1DeleteOptions, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async listValidatingAdmissionPolicy(pretty?: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, watch?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listValidatingAdmissionPolicyBinding(pretty?: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, watch?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class AdmissionregistrationV1alpha1ApiResponseProcessor {
     ...
     */
     public async createValidatingAdmissionPolicy(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicy > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicyBinding > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listValidatingAdmissionPolicy(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicyList > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicyBindingList > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchValidatingAdmissionPolicy(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1alpha1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicyBinding > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1alpha1ValidatingAdmissionPolicyBinding = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readValidatingAdmissionPolicy(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1alpha1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicyBinding > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1alpha1ValidatingAdmissionPolicyBinding = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceValidatingAdmissionPolicy(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1alpha1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1alpha1ValidatingAdmissionPolicyBinding > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1alpha1ValidatingAdmissionPolicyBinding = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),

...
export class StorageV1beta1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createNamespacedCSIStorageCapacity(namespace: string, body: V1beta1CSIStorageCapacity, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new RequiredError("StorageV1beta1Api", "createNamespacedCSIStorageCapacity", "namespace");
        }


        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("StorageV1beta1Api", "createNamespacedCSIStorageCapacity", "body");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(body, "V1beta1CSIStorageCapacity", ""),
            contentType
        );
    ...
    public async deleteCollectionNamespacedCSIStorageCapacity(namespace: string, pretty?: string, _continue?: string, dryRun?: string, fieldSelector?: string, gracePeriodSeconds?: number, labelSelector?: string, limit?: number, orphanDependents?: boolean, propagationPolicy?: string, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, body?: V1DeleteOptions, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new RequiredError("StorageV1beta1Api", "deleteCollectionNamespacedCSIStorageCapacity", "namespace");
        }
    ...
    public async deleteNamespacedCSIStorageCapacity(name: string, namespace: string, pretty?: string, dryRun?: string, gracePeriodSeconds?: number, orphanDependents?: boolean, propagationPolicy?: string, body?: V1DeleteOptions, _options?: Configuration): Promise<RequestContext> {
        ...
        if (name === null || name === undefined) {
            throw new RequiredError("StorageV1beta1Api", "deleteNamespacedCSIStorageCapacity", "name");
        }


        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new RequiredError("StorageV1beta1Api", "deleteNamespacedCSIStorageCapacity", "namespace");
        }
    ...
    public async listNamespacedCSIStorageCapacity(namespace: string, pretty?: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, watch?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new RequiredError("StorageV1beta1Api", "listNamespacedCSIStorageCapacity", "namespace");
        }
    ...
    public async patchNamespacedCSIStorageCapacity(name: string, namespace: string, body: any, pretty?: string, dryRun?: string, fieldManager?: string, force?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("StorageV1beta1Api", "patchNamespacedCSIStorageCapacity", "name");
        }


        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new RequiredError("StorageV1beta1Api", "patchNamespacedCSIStorageCapacity", "namespace");
        }


        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("StorageV1beta1Api", "patchNamespacedCSIStorageCapacity", "body");
        }
    ...
    public async readNamespacedCSIStorageCapacity(name: string, namespace: string, pretty?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("StorageV1beta1Api", "readNamespacedCSIStorageCapacity", "name");
        }


        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new RequiredError("StorageV1beta1Api", "readNamespacedCSIStorageCapacity", "namespace");
        }
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedCSIStorageCapacity(name: string, namespace: string, body: V1beta1CSIStorageCapacity, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("StorageV1beta1Api", "replaceNamespacedCSIStorageCapacity", "name");
        }


        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new RequiredError("StorageV1beta1Api", "replaceNamespacedCSIStorageCapacity", "namespace");
        }


        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("StorageV1beta1Api", "replaceNamespacedCSIStorageCapacity", "body");
        }
...
export class StorageV1beta1ApiResponseProcessor {
     ...
     */
     public async createNamespacedCSIStorageCapacityWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1beta1CSIStorageCapacity >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1CSIStorageCapacity = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "V1beta1CSIStorageCapacity", ""
            ) as V1beta1CSIStorageCapacity;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listCSIStorageCapacityForAllNamespacesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1beta1CSIStorageCapacityList >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1CSIStorageCapacityList = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "V1beta1CSIStorageCapacityList", ""
            ) as V1beta1CSIStorageCapacityList;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("401", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "Unauthorized", undefined, response.headers);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listNamespacedCSIStorageCapacityWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1beta1CSIStorageCapacityList >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1CSIStorageCapacityList = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchNamespacedCSIStorageCapacityWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1beta1CSIStorageCapacity >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1CSIStorageCapacity = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readNamespacedCSIStorageCapacityWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1beta1CSIStorageCapacity >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1CSIStorageCapacity = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceNamespacedCSIStorageCapacityWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1beta1CSIStorageCapacity >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1CSIStorageCapacity = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),

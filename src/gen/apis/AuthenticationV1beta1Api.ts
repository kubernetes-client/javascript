...
export class AuthenticationV1beta1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createSelfSubjectReview(body: V1beta1SelfSubjectReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("AuthenticationV1beta1Api", "createSelfSubjectReview", "body");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(body, "V1beta1SelfSubjectReview", ""),
            contentType
        );
...
export class AuthenticationV1beta1ApiResponseProcessor {
     ...
     */
     public async createSelfSubjectReviewWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1beta1SelfSubjectReview >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1SelfSubjectReview = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "V1beta1SelfSubjectReview", ""
            ) as V1beta1SelfSubjectReview;

...
export class AdmissionregistrationV1beta1ApiResponseProcessor {
     ...
     */
     public async createValidatingAdmissionPolicy(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicy > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicyBinding > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteCollectionValidatingAdmissionPolicy(response: ResponseContext): Promise<V1Status > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteCollectionValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1Status > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1Status = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteValidatingAdmissionPolicy(response: ResponseContext): Promise<V1Status > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1Status = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1Status > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1Status = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listValidatingAdmissionPolicy(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicyList > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicyBindingList > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchValidatingAdmissionPolicy(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicyBinding > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicyBinding = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchValidatingAdmissionPolicyStatus(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readValidatingAdmissionPolicy(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicyBinding > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicyBinding = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readValidatingAdmissionPolicyStatus(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceValidatingAdmissionPolicy(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceValidatingAdmissionPolicyBinding(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicyBinding > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicyBinding = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceValidatingAdmissionPolicyStatus(response: ResponseContext): Promise<V1beta1ValidatingAdmissionPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1ValidatingAdmissionPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),

...
export class AutoscalingV2ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async listHorizontalPodAutoscalerForAllNamespaces(allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, resourceVersionMatch?: string, sendInitialEvents?: boolean, shardSelector?: string, timeoutSeconds?: number, watch?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class AutoscalingV2ApiResponseProcessor {
     ...
     */
     public async createNamespacedHorizontalPodAutoscalerWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscaler >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listHorizontalPodAutoscalerForAllNamespacesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscalerList >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listNamespacedHorizontalPodAutoscalerWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscalerList >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V2HorizontalPodAutoscalerList = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchNamespacedHorizontalPodAutoscalerWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscaler >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V2HorizontalPodAutoscaler = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchNamespacedHorizontalPodAutoscalerStatusWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscaler >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V2HorizontalPodAutoscaler = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readNamespacedHorizontalPodAutoscalerWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscaler >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V2HorizontalPodAutoscaler = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readNamespacedHorizontalPodAutoscalerStatusWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscaler >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V2HorizontalPodAutoscaler = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceNamespacedHorizontalPodAutoscalerWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscaler >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V2HorizontalPodAutoscaler = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceNamespacedHorizontalPodAutoscalerStatusWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V2HorizontalPodAutoscaler >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V2HorizontalPodAutoscaler = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),

...
export class NodeV1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createRuntimeClass(body: V1RuntimeClass, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceRuntimeClass(name: string, body: V1RuntimeClass, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class NodeV1ApiResponseProcessor {
     ...
     */
     public async createRuntimeClass(response: ResponseContext): Promise<V1RuntimeClass > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listRuntimeClass(response: ResponseContext): Promise<V1RuntimeClassList > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchRuntimeClass(response: ResponseContext): Promise<V1RuntimeClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1RuntimeClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readRuntimeClass(response: ResponseContext): Promise<V1RuntimeClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1RuntimeClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceRuntimeClass(response: ResponseContext): Promise<V1RuntimeClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1RuntimeClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),

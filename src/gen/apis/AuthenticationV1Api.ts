...
export class AuthenticationV1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createSelfSubjectReview(body: V1SelfSubjectReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(body, "V1SelfSubjectReview", ""),
            contentType
        );
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async createTokenReview(body: V1TokenReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(body, "V1TokenReview", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class AuthenticationV1ApiResponseProcessor {
     ...
     */
     public async createSelfSubjectReviewWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1SelfSubjectReview >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1SelfSubjectReview = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createTokenReviewWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1TokenReview >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1TokenReview = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "V1TokenReview", ""
            ) as V1TokenReview;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);

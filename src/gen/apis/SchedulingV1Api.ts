...
export class SchedulingV1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createPriorityClass(body: V1PriorityClass, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replacePriorityClass(name: string, body: V1PriorityClass, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class SchedulingV1ApiResponseProcessor {
     ...
     */
     public async createPriorityClass(response: ResponseContext): Promise<V1PriorityClass > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listPriorityClass(response: ResponseContext): Promise<V1PriorityClassList > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchPriorityClass(response: ResponseContext): Promise<V1PriorityClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1PriorityClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readPriorityClass(response: ResponseContext): Promise<V1PriorityClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1PriorityClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replacePriorityClass(response: ResponseContext): Promise<V1PriorityClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1PriorityClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),

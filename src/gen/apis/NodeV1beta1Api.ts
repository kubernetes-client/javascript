...
export class NodeV1beta1ApiResponseProcessor {
     ...
     */
     public async createRuntimeClass(response: ResponseContext): Promise<V1beta1RuntimeClass > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listRuntimeClass(response: ResponseContext): Promise<V1beta1RuntimeClassList > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchRuntimeClass(response: ResponseContext): Promise<V1beta1RuntimeClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1RuntimeClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async readRuntimeClass(response: ResponseContext): Promise<V1beta1RuntimeClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1RuntimeClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async replaceRuntimeClass(response: ResponseContext): Promise<V1beta1RuntimeClass > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: V1beta1RuntimeClass = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),

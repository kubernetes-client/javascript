...
------------- | ------------- | -------------
[**createNamespacedPodGroup**](SchedulingV1beta1Api.md#createNamespacedPodGroup) | **POST** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups | 
[**createNamespacedWorkload**](SchedulingV1beta1Api.md#createNamespacedWorkload) | **POST** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/workloads | 
[**deleteCollectionNamespacedPodGroup**](SchedulingV1beta1Api.md#deleteCollectionNamespacedPodGroup) | **DELETE** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups | 
[**deleteCollectionNamespacedWorkload**](SchedulingV1beta1Api.md#deleteCollectionNamespacedWorkload) | **DELETE** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/workloads | 
[**deleteNamespacedPodGroup**](SchedulingV1beta1Api.md#deleteNamespacedPodGroup) | **DELETE** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups/{name} | 
[**deleteNamespacedWorkload**](SchedulingV1beta1Api.md#deleteNamespacedWorkload) | **DELETE** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/workloads/{name} | 
[**getAPIResources**](SchedulingV1beta1Api.md#getAPIResources) | **GET** /apis/scheduling.k8s.io/v1beta1/ | 
[**listNamespacedPodGroup**](SchedulingV1beta1Api.md#listNamespacedPodGroup) | **GET** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups | 
[**listNamespacedWorkload**](SchedulingV1beta1Api.md#listNamespacedWorkload) | **GET** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/workloads | 
[**listPodGroupForAllNamespaces**](SchedulingV1beta1Api.md#listPodGroupForAllNamespaces) | **GET** /apis/scheduling.k8s.io/v1beta1/podgroups | 
[**listWorkloadForAllNamespaces**](SchedulingV1beta1Api.md#listWorkloadForAllNamespaces) | **GET** /apis/scheduling.k8s.io/v1beta1/workloads | 
[**patchNamespacedPodGroup**](SchedulingV1beta1Api.md#patchNamespacedPodGroup) | **PATCH** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups/{name} | 
[**patchNamespacedPodGroupStatus**](SchedulingV1beta1Api.md#patchNamespacedPodGroupStatus) | **PATCH** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups/{name}/status | 
[**patchNamespacedWorkload**](SchedulingV1beta1Api.md#patchNamespacedWorkload) | **PATCH** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/workloads/{name} | 
[**readNamespacedPodGroup**](SchedulingV1beta1Api.md#readNamespacedPodGroup) | **GET** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups/{name} | 
[**readNamespacedPodGroupStatus**](SchedulingV1beta1Api.md#readNamespacedPodGroupStatus) | **GET** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups/{name}/status | 
[**readNamespacedWorkload**](SchedulingV1beta1Api.md#readNamespacedWorkload) | **GET** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/workloads/{name} | 
[**replaceNamespacedPodGroup**](SchedulingV1beta1Api.md#replaceNamespacedPodGroup) | **PUT** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups/{name} | 
[**replaceNamespacedPodGroupStatus**](SchedulingV1beta1Api.md#replaceNamespacedPodGroupStatus) | **PUT** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/podgroups/{name}/status | 
[**replaceNamespacedWorkload**](SchedulingV1beta1Api.md#replaceNamespacedWorkload) | **PUT** /apis/scheduling.k8s.io/v1beta1/namespaces/{namespace}/workloads/{name} | 


# **createNamespacedPodGroup**
> V1beta1PodGroup createNamespacedPodGroup(body)
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiCreateNamespacedPodGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiCreateNamespacedPodGroupRequest = {
...
> V1beta1Workload createNamespacedWorkload(body)
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiCreateNamespacedWorkloadRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiCreateNamespacedWorkloadRequest = {
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiDeleteCollectionNamespacedPodGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiDeleteCollectionNamespacedPodGroupRequest = {
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
    // If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiDeleteCollectionNamespacedWorkloadRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiDeleteCollectionNamespacedWorkloadRequest = {
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
    // If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiDeleteNamespacedPodGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiDeleteNamespacedPodGroupRequest = {
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiDeleteNamespacedWorkloadRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiDeleteNamespacedWorkloadRequest = {
...
> V1beta1PodGroupList listNamespacedPodGroup()
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiListNamespacedPodGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiListNamespacedPodGroupRequest = {
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
    // If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
> V1beta1WorkloadList listNamespacedWorkload()
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiListNamespacedWorkloadRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiListNamespacedWorkloadRequest = {
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
    // If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
> V1beta1PodGroupList listPodGroupForAllNamespaces()
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiListPodGroupForAllNamespacesRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiListPodGroupForAllNamespacesRequest = {
    // allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server\'s discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. (optional)
  allowWatchBookmarks: true,
    // The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications. (optional)
  _continue: "continue_example",
...
> V1beta1WorkloadList listWorkloadForAllNamespaces()
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiListWorkloadForAllNamespacesRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiListWorkloadForAllNamespacesRequest = {
    // allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server\'s discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. (optional)
  allowWatchBookmarks: true,
    // The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications. (optional)
  _continue: "continue_example",
...
> V1beta1PodGroup patchNamespacedPodGroup(body)
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiPatchNamespacedPodGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiPatchNamespacedPodGroupRequest = {
    // name of the PodGroup
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1PodGroup patchNamespacedPodGroupStatus(body)
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiPatchNamespacedPodGroupStatusRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiPatchNamespacedPodGroupStatusRequest = {
    // name of the PodGroup
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1Workload patchNamespacedWorkload(body)
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiPatchNamespacedWorkloadRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiPatchNamespacedWorkloadRequest = {
    // name of the Workload
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1PodGroup readNamespacedPodGroup()
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiReadNamespacedPodGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiReadNamespacedPodGroupRequest = {
    // name of the PodGroup
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1PodGroup readNamespacedPodGroupStatus()
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiReadNamespacedPodGroupStatusRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiReadNamespacedPodGroupStatusRequest = {
    // name of the PodGroup
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1Workload readNamespacedWorkload()
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiReadNamespacedWorkloadRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiReadNamespacedWorkloadRequest = {
    // name of the Workload
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1PodGroup replaceNamespacedPodGroup(body)
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiReplaceNamespacedPodGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiReplaceNamespacedPodGroupRequest = {
    // name of the PodGroup
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1PodGroup replaceNamespacedPodGroupStatus(body)
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiReplaceNamespacedPodGroupStatusRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiReplaceNamespacedPodGroupStatusRequest = {
    // name of the PodGroup
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1Workload replaceNamespacedWorkload(body)
...
```typescript
import { createConfiguration, SchedulingV1beta1Api } from '';
import type { SchedulingV1beta1ApiReplaceNamespacedWorkloadRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SchedulingV1beta1Api(configuration);

const request: SchedulingV1beta1ApiReplaceNamespacedWorkloadRequest = {
    // name of the Workload
  name: "name_example",
    // object name and auth scope, such as for teams and projects
  namespace: "namespace_example",

...
> V1beta1Event createNamespacedEvent(body)
...
const apiInstance = new .EventsV1beta1Api(configuration);

let body:.EventsV1beta1ApiCreateNamespacedEventRequest = {
...
let body:.EventsV1beta1ApiDeleteCollectionNamespacedEventRequest = {
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
let body:.EventsV1beta1ApiDeleteNamespacedEventRequest = {
...
> V1beta1EventList listEventForAllNamespaces()
...
let body:.EventsV1beta1ApiListEventForAllNamespacesRequest = {
...
# **listNamespacedEvent**
> V1beta1EventList listNamespacedEvent()
...
let body:.EventsV1beta1ApiListNamespacedEventRequest = {
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
> V1beta1Event patchNamespacedEvent(body)
...
let body:.EventsV1beta1ApiPatchNamespacedEventRequest = {
  // string | name of the Event
  name: "name_example",
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
# **readNamespacedEvent**
> V1beta1Event readNamespacedEvent()
...
let body:.EventsV1beta1ApiReadNamespacedEventRequest = {
  // string | name of the Event
  name: "name_example",
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
> V1beta1Event replaceNamespacedEvent(body)
...
let body:.EventsV1beta1ApiReplaceNamespacedEventRequest = {
  // string | name of the Event
  name: "name_example",
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",

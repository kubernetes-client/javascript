...
*/
export class V1beta1PodGroupStatus {
    /**
    ...
    */
    'resourceClaimStatuses'?: Array<V1beta1PodGroupResourceClaimStatus>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<V1beta1PodGroupResourceClaimStatus>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return V1beta1PodGroupStatus.attributeTypeMap;
    }

...
import { V1CSIStorageCapacityList } from './V1CSIStorageCapacityList';
...
import { V1alpha1AllocationResult } from './V1alpha1AllocationResult';
import { V1alpha1ClusterCIDR } from './V1alpha1ClusterCIDR';
import { V1alpha1ClusterCIDRList } from './V1alpha1ClusterCIDRList';
...
import { V1alpha1PodScheduling } from './V1alpha1PodScheduling';
import { V1alpha1PodSchedulingList } from './V1alpha1PodSchedulingList';
import { V1alpha1PodSchedulingSpec } from './V1alpha1PodSchedulingSpec';
import { V1alpha1PodSchedulingStatus } from './V1alpha1PodSchedulingStatus';
import { V1alpha1ResourceClaim } from './V1alpha1ResourceClaim';
import { V1alpha1ResourceClaimConsumerReference } from './V1alpha1ResourceClaimConsumerReference';
import { V1alpha1ResourceClaimList } from './V1alpha1ResourceClaimList';
import { V1alpha1ResourceClaimParametersReference } from './V1alpha1ResourceClaimParametersReference';
import { V1alpha1ResourceClaimSchedulingStatus } from './V1alpha1ResourceClaimSchedulingStatus';
import { V1alpha1ResourceClaimSpec } from './V1alpha1ResourceClaimSpec';
import { V1alpha1ResourceClaimStatus } from './V1alpha1ResourceClaimStatus';
import { V1alpha1ResourceClaimTemplate } from './V1alpha1ResourceClaimTemplate';
import { V1alpha1ResourceClaimTemplateList } from './V1alpha1ResourceClaimTemplateList';
import { V1alpha1ResourceClaimTemplateSpec } from './V1alpha1ResourceClaimTemplateSpec';
import { V1alpha1ResourceClass } from './V1alpha1ResourceClass';
import { V1alpha1ResourceClassList } from './V1alpha1ResourceClassList';
import { V1alpha1ResourceClassParametersReference } from './V1alpha1ResourceClassParametersReference';
...
import { V1alpha1ValidatingAdmissionPolicyBindingList } from './V1alpha1ValidatingAdmissionPolicyBindingList';
import { V1alpha1ValidatingAdmissionPolicyBindingSpec } from './V1alpha1ValidatingAdmissionPolicyBindingSpec';
import { V1alpha1ValidatingAdmissionPolicyList } from './V1alpha1ValidatingAdmissionPolicyList';
...
import { V1beta2FlowSchemaList } from './V1beta2FlowSchemaList';
...
import { V1beta2PriorityLevelConfigurationList } from './V1beta2PriorityLevelConfigurationList';
...
import { V1beta3FlowSchemaList } from './V1beta3FlowSchemaList';
...
import { V1beta3PriorityLevelConfigurationList } from './V1beta3PriorityLevelConfigurationList';
...
import { V2HorizontalPodAutoscalerList } from './V2HorizontalPodAutoscalerList';
...
let typeMap: {[index: string]: any} = {
    ...
    "V1alpha1AllocationResult": V1alpha1AllocationResult,
    ...
    "V1alpha1PodScheduling": V1alpha1PodScheduling,
    "V1alpha1PodSchedulingList": V1alpha1PodSchedulingList,
    "V1alpha1PodSchedulingSpec": V1alpha1PodSchedulingSpec,
    "V1alpha1PodSchedulingStatus": V1alpha1PodSchedulingStatus,
    "V1alpha1ResourceClaim": V1alpha1ResourceClaim,
    "V1alpha1ResourceClaimConsumerReference": V1alpha1ResourceClaimConsumerReference,
    "V1alpha1ResourceClaimList": V1alpha1ResourceClaimList,
    "V1alpha1ResourceClaimParametersReference": V1alpha1ResourceClaimParametersReference,
    "V1alpha1ResourceClaimSchedulingStatus": V1alpha1ResourceClaimSchedulingStatus,
    "V1alpha1ResourceClaimSpec": V1alpha1ResourceClaimSpec,
    "V1alpha1ResourceClaimStatus": V1alpha1ResourceClaimStatus,
    "V1alpha1ResourceClaimTemplate": V1alpha1ResourceClaimTemplate,
    "V1alpha1ResourceClaimTemplateList": V1alpha1ResourceClaimTemplateList,
    "V1alpha1ResourceClaimTemplateSpec": V1alpha1ResourceClaimTemplateSpec,
    "V1alpha1ResourceClass": V1alpha1ResourceClass,
    "V1alpha1ResourceClassList": V1alpha1ResourceClassList,
    "V1alpha1ResourceClassParametersReference": V1alpha1ResourceClassParametersReference,

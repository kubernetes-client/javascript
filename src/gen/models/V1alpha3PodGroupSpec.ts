...
*/
export class V1alpha3PodGroupSpec {
    'disruptionMode'?: V1alpha3DisruptionMode;
    /**
    ...
    */
    'resourceClaims'?: Array<V1alpha3PodGroupResourceClaim>;
    'schedulingConstraints'?: V1alpha3PodGroupSchedulingConstraints;
    'schedulingPolicy': V1alpha3PodGroupSchedulingPolicy;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<V1alpha3PodGroupResourceClaim>",
            "format": ""
        },
        {
            "name": "schedulingConstraints",
            "baseName": "schedulingConstraints",
            "type": "V1alpha3PodGroupSchedulingConstraints",
            "format": ""
        },
        {
            "name": "schedulingPolicy",
            "baseName": "schedulingPolicy",
            "type": "V1alpha3PodGroupSchedulingPolicy",
            "format": ""
        },
        {
            "name": "workloadRef",
    ...
    static getAttributeTypeMap() {
        return V1alpha3PodGroupSpec.attributeTypeMap;
    }

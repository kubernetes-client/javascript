...
export class V1Device {
    ...
    */
    'nodeAllocatableResourceMappings'?: { [key: string]: V1NodeAllocatableResourceMapping; };
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "nodeAllocatableResourceMappings",
            "type": "{ [key: string]: V1NodeAllocatableResourceMapping; }",
            "format": ""
        },
        {
            "name": "nodeName",

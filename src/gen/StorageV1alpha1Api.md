...
let body:.StorageV1alpha1ApiCreateVolumeAttributesClassRequest = {
...
apiInstance.createVolumeAttributesClass(body).then((data:any) => {
...
let body:.StorageV1alpha1ApiDeleteCollectionVolumeAttributesClassRequest = {
  // string | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.deleteCollectionVolumeAttributesClass(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StorageV1alpha1ApiDeleteVolumeAttributesClassRequest = {
  // string | name of the VolumeAttributesClass
  name: "name_example",
  // string | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
  // string | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
...
apiInstance.deleteVolumeAttributesClass(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StorageV1alpha1ApiListVolumeAttributesClassRequest = {
  // string | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.listVolumeAttributesClass(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StorageV1alpha1ApiPatchVolumeAttributesClassRequest = {
  // string | name of the VolumeAttributesClass
  name: "name_example",
  // any
  body: {},
...
apiInstance.patchVolumeAttributesClass(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StorageV1alpha1ApiReadVolumeAttributesClassRequest = {
  // string | name of the VolumeAttributesClass
  name: "name_example",
  // string | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.readVolumeAttributesClass(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.StorageV1alpha1ApiReplaceVolumeAttributesClassRequest = {
  // string | name of the VolumeAttributesClass
  name: "name_example",
  // V1alpha1VolumeAttributesClass
  body: {
...
apiInstance.replaceVolumeAttributesClass(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```

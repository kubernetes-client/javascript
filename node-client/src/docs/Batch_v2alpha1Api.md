...
let apiInstance = new KubernetesJsClient.Batch_v2alpha1Api();

let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects

let body = new KubernetesJsClient.V2alpha1CronJob(); // V2alpha1CronJob | 
...
apiInstance.deleteNamespacedCronJob(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);

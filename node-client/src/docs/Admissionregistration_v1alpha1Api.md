# KubernetesJsClient.Admissionregistration_v1alpha1Api
...
> V1alpha1InitializerConfiguration createInitializerConfiguration(body, opts)
...
let apiInstance = new KubernetesJsClient.Admissionregistration_v1alpha1Api();

let body = new KubernetesJsClient.V1alpha1InitializerConfiguration(); // V1alpha1InitializerConfiguration | 

let opts = { 
  'pretty': "pretty_example", // String | If 'true', then the output is pretty printed.
};

apiInstance.createInitializerConfiguration(body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> V1Status deleteCollectionInitializerConfiguration(opts)
...
apiInstance.deleteCollectionInitializerConfiguration(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> V1Status deleteInitializerConfiguration(name, body, opts)
...
let name = "name_example"; // String | name of the InitializerConfiguration
...
apiInstance.deleteInitializerConfiguration(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> V1alpha1InitializerConfigurationList listInitializerConfiguration(opts)
...
apiInstance.listInitializerConfiguration(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> V1alpha1InitializerConfiguration patchInitializerConfiguration(name, body, opts)
...
apiInstance.patchInitializerConfiguration(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> V1alpha1InitializerConfiguration readInitializerConfiguration(name, , opts)
...
apiInstance.readInitializerConfiguration(name, , opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> V1alpha1InitializerConfiguration replaceInitializerConfiguration(name, body, opts)
...
apiInstance.replaceInitializerConfiguration(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);

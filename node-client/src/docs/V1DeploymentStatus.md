# KubernetesJsClient.V1DeploymentStatus
...
**conditions** | [**[V1DeploymentCondition]**](V1DeploymentCondition.md) | Represents the latest available observations of a deployment&#39;s current state. | [optional] 

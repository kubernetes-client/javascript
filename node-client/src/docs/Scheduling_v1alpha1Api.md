# KubernetesJsClient.Scheduling_v1alpha1Api
...
# **createPriorityClass**
> V1alpha1PriorityClass createPriorityClass(body, opts)
...
let apiInstance = new KubernetesJsClient.Scheduling_v1alpha1Api();

let body = new KubernetesJsClient.V1alpha1PriorityClass(); // V1alpha1PriorityClass | 
...
# **deletePriorityClass**
> V1Status deletePriorityClass(name, body, opts)
...
apiInstance.deletePriorityClass(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
# **listPriorityClass**
> V1alpha1PriorityClassList listPriorityClass(opts)
...
# **patchPriorityClass**
> V1alpha1PriorityClass patchPriorityClass(name, body, opts)
...
# **readPriorityClass**
> V1alpha1PriorityClass readPriorityClass(name, , opts)
...
> V1alpha1PriorityClass replacePriorityClass(name, body, opts)

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1IngressRule();
  });
  ...
  describe('V1beta1IngressRule', function() {
    it('should create an instance of V1beta1IngressRule', function() {
      ...
      //var instane = new KubernetesJsClient.V1beta1IngressRule();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1IngressRule);
    });

...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1ReplicaSetCondition
...
export default class V1beta1ReplicaSetCondition {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1ReplicaSetCondition
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1ReplicaSetCondition} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1ReplicaSetCondition} The populated <code>V1beta1ReplicaSetCondition</code> instance.
    */

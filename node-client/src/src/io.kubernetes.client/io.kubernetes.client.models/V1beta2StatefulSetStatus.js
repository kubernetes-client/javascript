...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta2StatefulSetStatus
...
export default class V1beta2StatefulSetStatus {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta2StatefulSetStatus
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta2StatefulSetStatus} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta2StatefulSetStatus} The populated <code>V1beta2StatefulSetStatus</code> instance.
    */
    ...
    * @member {Array.<module:io.kubernetes.client/io.kubernetes.client.models/V1beta2StatefulSetCondition>} conditions
    */

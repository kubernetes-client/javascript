...
* @module io.kubernetes.client/io.kubernetes.client.models/V1ISCSIVolumeSource
...
export default class V1ISCSIVolumeSource {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1ISCSIVolumeSource
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1ISCSIVolumeSource} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1ISCSIVolumeSource} The populated <code>V1ISCSIVolumeSource</code> instance.
    */

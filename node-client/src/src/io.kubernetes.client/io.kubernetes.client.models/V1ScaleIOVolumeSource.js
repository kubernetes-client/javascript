...
* @module io.kubernetes.client/io.kubernetes.client.models/V1ScaleIOVolumeSource
...
export default class V1ScaleIOVolumeSource {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1ScaleIOVolumeSource
    * @class
    * @param gateway {String} The host address of the ScaleIO API Gateway.
    * @param secretRef {module:io.kubernetes.client/io.kubernetes.client.models/V1LocalObjectReference} SecretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail.
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1ScaleIOVolumeSource} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1ScaleIOVolumeSource} The populated <code>V1ScaleIOVolumeSource</code> instance.
    */

...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetStatus
...
export default class V1beta1StatefulSetStatus {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetStatus
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetStatus} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetStatus} The populated <code>V1beta1StatefulSetStatus</code> instance.
    */
    ...
    * @member {Array.<module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetCondition>} conditions
    */

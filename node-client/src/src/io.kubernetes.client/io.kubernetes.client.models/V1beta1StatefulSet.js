...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSet
...
export default class V1beta1StatefulSet {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSet
    * @class
    */
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSet} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSet} The populated <code>V1beta1StatefulSet</code> instance.
    */
    ...
    * @member {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetSpec} spec
    */
    spec = undefined;
    /**
    * Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
    * @member {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetStatus} status
    */
    status = undefined;

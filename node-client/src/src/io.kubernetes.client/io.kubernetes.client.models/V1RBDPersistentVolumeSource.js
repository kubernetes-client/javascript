...
* @module io.kubernetes.client/io.kubernetes.client.models/V1RBDPersistentVolumeSource
...
export default class V1RBDPersistentVolumeSource {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1RBDPersistentVolumeSource
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1RBDPersistentVolumeSource} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1RBDPersistentVolumeSource} The populated <code>V1RBDPersistentVolumeSource</code> instance.
    */

...
* @module io.kubernetes.client/io.kubernetes.client.models/V1FlexPersistentVolumeSource
...
export default class V1FlexPersistentVolumeSource {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1FlexPersistentVolumeSource
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1FlexPersistentVolumeSource} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1FlexPersistentVolumeSource} The populated <code>V1FlexPersistentVolumeSource</code> instance.
    */

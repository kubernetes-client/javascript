...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta2DeploymentStatus
...
export default class V1beta2DeploymentStatus {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta2DeploymentStatus
    * @class
    */
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta2DeploymentStatus} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta2DeploymentStatus} The populated <code>V1beta2DeploymentStatus</code> instance.
    */
    ...
    * @member {Array.<module:io.kubernetes.client/io.kubernetes.client.models/V1beta2DeploymentCondition>} conditions
    */

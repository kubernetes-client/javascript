...
* @module io.kubernetes.client/io.kubernetes.client.models/V1alpha1Subject
* @version 0.3-SNAPSHOT
*/
export default class V1alpha1Subject {
    /**
    * Constructs a new <code>V1alpha1Subject</code>.
    * Subject contains a reference to the object or user identities a role binding applies to.  This can either hold a direct API object reference, or a value for non-objects such as user and group names.
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1alpha1Subject
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1alpha1Subject} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1alpha1Subject} The populated <code>V1alpha1Subject</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1Subject();

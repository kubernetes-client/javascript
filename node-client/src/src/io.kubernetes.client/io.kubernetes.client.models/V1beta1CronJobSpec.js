...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1CronJobSpec
...
export default class V1beta1CronJobSpec {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1CronJobSpec
    * @class
    * @param jobTemplate {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1JobTemplateSpec} Specifies the job that will be created when executing a CronJob.
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1CronJobSpec} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1CronJobSpec} The populated <code>V1beta1CronJobSpec</code> instance.
    */
    ...
    * @member {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1JobTemplateSpec} jobTemplate
    */

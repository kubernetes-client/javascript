...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1PodDisruptionBudgetStatus
...
export default class V1beta1PodDisruptionBudgetStatus {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1PodDisruptionBudgetStatus
    * @class
    ...
    */
    ...
    constructor(currentHealthy, desiredHealthy, disruptedPods, disruptionsAllowed, expectedPods) {
        

        
        

        this['currentHealthy'] = currentHealthy;this['desiredHealthy'] = desiredHealthy;this['disruptedPods'] = disruptedPods;this['disruptionsAllowed'] = disruptionsAllowed;this['expectedPods'] = expectedPods;
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1PodDisruptionBudgetStatus} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1PodDisruptionBudgetStatus} The populated <code>V1beta1PodDisruptionBudgetStatus</code> instance.
    */

...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1DaemonSetStatus
...
export default class V1beta1DaemonSetStatus {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1DaemonSetStatus
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1DaemonSetStatus} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1DaemonSetStatus} The populated <code>V1beta1DaemonSetStatus</code> instance.
    */
    ...
    * @member {Array.<module:io.kubernetes.client/io.kubernetes.client.models/V1beta1DaemonSetCondition>} conditions
    */

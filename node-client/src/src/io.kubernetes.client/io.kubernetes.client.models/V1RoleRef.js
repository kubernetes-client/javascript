...
* @module io.kubernetes.client/io.kubernetes.client.models/V1RoleRef
...
export default class V1RoleRef {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1RoleRef
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1RoleRef} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1RoleRef} The populated <code>V1RoleRef</code> instance.
    */

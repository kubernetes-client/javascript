...
* @module io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetSpec
...
export default class V1DaemonSetSpec {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetSpec
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetSpec} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetSpec} The populated <code>V1DaemonSetSpec</code> instance.
    */
    ...
    * @member {module:io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetUpdateStrategy} updateStrategy
    */

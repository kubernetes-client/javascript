...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetSpec
...
export default class V1beta1StatefulSetSpec {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetSpec
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetSpec} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetSpec} The populated <code>V1beta1StatefulSetSpec</code> instance.
    */
    ...
    * @member {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1StatefulSetUpdateStrategy} updateStrategy
    */

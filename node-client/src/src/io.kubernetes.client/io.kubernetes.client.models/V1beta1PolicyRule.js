...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1PolicyRule
...
export default class V1beta1PolicyRule {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1PolicyRule
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1PolicyRule} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1PolicyRule} The populated <code>V1beta1PolicyRule</code> instance.
    */

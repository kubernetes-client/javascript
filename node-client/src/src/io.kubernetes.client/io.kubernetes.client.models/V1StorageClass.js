...
* @module io.kubernetes.client/io.kubernetes.client.models/V1StorageClass
...
export default class V1StorageClass {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1StorageClass
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1StorageClass} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1StorageClass} The populated <code>V1StorageClass</code> instance.
    */

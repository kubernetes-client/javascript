...
* @module io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetStatus
...
export default class V1DaemonSetStatus {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetStatus
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetStatus} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetStatus} The populated <code>V1DaemonSetStatus</code> instance.
    */
    ...
    * @member {Array.<module:io.kubernetes.client/io.kubernetes.client.models/V1DaemonSetCondition>} conditions
    */

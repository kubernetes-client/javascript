...
* @module io.kubernetes.client/io.kubernetes.client.models/V1ReplicaSetSpec
...
export default class V1ReplicaSetSpec {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1ReplicaSetSpec
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1ReplicaSetSpec} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1ReplicaSetSpec} The populated <code>V1ReplicaSetSpec</code> instance.
    */

...
* @module io.kubernetes.client/io.kubernetes.client.models/V1ResourceRule
...
export default class V1ResourceRule {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1ResourceRule
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1ResourceRule} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1ResourceRule} The populated <code>V1ResourceRule</code> instance.
    */

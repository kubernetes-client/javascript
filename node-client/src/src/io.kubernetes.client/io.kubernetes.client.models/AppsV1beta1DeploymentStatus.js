...
* @module io.kubernetes.client/io.kubernetes.client.models/AppsV1beta1DeploymentStatus
...
export default class AppsV1beta1DeploymentStatus {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/AppsV1beta1DeploymentStatus
    * @class
    */
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/AppsV1beta1DeploymentStatus} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/AppsV1beta1DeploymentStatus} The populated <code>AppsV1beta1DeploymentStatus</code> instance.
    */
    ...
    * @member {Array.<module:io.kubernetes.client/io.kubernetes.client.models/AppsV1beta1DeploymentCondition>} conditions
    */

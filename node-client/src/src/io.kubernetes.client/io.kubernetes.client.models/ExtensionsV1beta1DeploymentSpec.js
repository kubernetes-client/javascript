...
* @module io.kubernetes.client/io.kubernetes.client.models/ExtensionsV1beta1DeploymentSpec
...
export default class ExtensionsV1beta1DeploymentSpec {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/ExtensionsV1beta1DeploymentSpec
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/ExtensionsV1beta1DeploymentSpec} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/ExtensionsV1beta1DeploymentSpec} The populated <code>ExtensionsV1beta1DeploymentSpec</code> instance.
    */
    ...
    * @member {module:io.kubernetes.client/io.kubernetes.client.models/ExtensionsV1beta1DeploymentStrategy} strategy
    */
    strategy = undefined;
    /**

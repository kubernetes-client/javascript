...
* @module io.kubernetes.client/io.kubernetes.client.models/V1beta1APIServiceSpec
...
export default class V1beta1APIServiceSpec {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1beta1APIServiceSpec
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1APIServiceSpec} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1beta1APIServiceSpec} The populated <code>V1beta1APIServiceSpec</code> instance.
    */
    ...
    * @member {module:io.kubernetes.client/io.kubernetes.client.models/ApiregistrationV1beta1ServiceReference} service
    */
    service = undefined;
    /**

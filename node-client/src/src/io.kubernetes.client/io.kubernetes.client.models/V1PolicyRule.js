...
* @module io.kubernetes.client/io.kubernetes.client.models/V1PolicyRule
...
export default class V1PolicyRule {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.models/V1PolicyRule
    * @class
    ...
    * @param {module:io.kubernetes.client/io.kubernetes.client.models/V1PolicyRule} obj Optional instance to populate.
    * @return {module:io.kubernetes.client/io.kubernetes.client.models/V1PolicyRule} The populated <code>V1PolicyRule</code> instance.
    */

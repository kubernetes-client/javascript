...
/**
* Storage service.
* @module io.kubernetes.client/io.kubernetes.client.apis/StorageApi
...
export default class StorageApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/StorageApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/StorageApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/StorageApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

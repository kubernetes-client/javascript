...
* @module io.kubernetes.client/io.kubernetes.client.apis/ApiextensionsApi
...
export default class ApiextensionsApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/ApiextensionsApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/ApiextensionsApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/ApiextensionsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

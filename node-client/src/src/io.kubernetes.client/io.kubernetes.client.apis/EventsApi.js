...
/**
* Events service.
* @module io.kubernetes.client/io.kubernetes.client.apis/EventsApi
...
export default class EventsApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/EventsApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/EventsApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/EventsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

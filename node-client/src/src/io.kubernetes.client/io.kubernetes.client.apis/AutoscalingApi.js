...
/**
* Autoscaling service.
* @module io.kubernetes.client/io.kubernetes.client.apis/AutoscalingApi
...
export default class AutoscalingApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/AutoscalingApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/AutoscalingApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/AutoscalingApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

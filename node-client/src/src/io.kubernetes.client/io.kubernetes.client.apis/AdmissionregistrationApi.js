...
* @module io.kubernetes.client/io.kubernetes.client.apis/AdmissionregistrationApi
...
export default class AdmissionregistrationApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/AdmissionregistrationApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/AdmissionregistrationApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/AdmissionregistrationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

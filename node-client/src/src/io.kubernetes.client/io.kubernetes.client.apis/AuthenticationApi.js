...
* @module io.kubernetes.client/io.kubernetes.client.apis/AuthenticationApi
...
export default class AuthenticationApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/AuthenticationApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/AuthenticationApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/AuthenticationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

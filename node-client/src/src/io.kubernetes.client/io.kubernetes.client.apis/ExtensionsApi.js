...
/**
* Extensions service.
* @module io.kubernetes.client/io.kubernetes.client.apis/ExtensionsApi
...
export default class ExtensionsApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/ExtensionsApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/ExtensionsApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/ExtensionsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

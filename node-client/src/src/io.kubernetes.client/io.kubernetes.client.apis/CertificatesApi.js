...
* @module io.kubernetes.client/io.kubernetes.client.apis/CertificatesApi
...
export default class CertificatesApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/CertificatesApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/CertificatesApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/CertificatesApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

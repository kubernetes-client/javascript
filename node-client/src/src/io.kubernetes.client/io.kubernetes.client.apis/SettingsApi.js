...
/**
* Settings service.
* @module io.kubernetes.client/io.kubernetes.client.apis/SettingsApi
...
export default class SettingsApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/SettingsApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/SettingsApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/SettingsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
* @module io.kubernetes.client/io.kubernetes.client.apis/RbacAuthorizationApi
...
export default class RbacAuthorizationApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/RbacAuthorizationApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/RbacAuthorizationApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/RbacAuthorizationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

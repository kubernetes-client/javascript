...
* @module io.kubernetes.client/io.kubernetes.client.apis/AuthorizationApi
...
export default class AuthorizationApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/AuthorizationApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/AuthorizationApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/AuthorizationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

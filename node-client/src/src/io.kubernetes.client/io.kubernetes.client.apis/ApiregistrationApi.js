...
* @module io.kubernetes.client/io.kubernetes.client.apis/ApiregistrationApi
...
export default class ApiregistrationApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/ApiregistrationApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/ApiregistrationApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/ApiregistrationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

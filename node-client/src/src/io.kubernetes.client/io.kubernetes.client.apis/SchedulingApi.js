...
/**
* Scheduling service.
* @module io.kubernetes.client/io.kubernetes.client.apis/SchedulingApi
...
export default class SchedulingApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/SchedulingApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/SchedulingApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/SchedulingApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

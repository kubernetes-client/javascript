...
/**
* Networking service.
* @module io.kubernetes.client/io.kubernetes.client.apis/NetworkingApi
...
export default class NetworkingApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/NetworkingApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/NetworkingApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/NetworkingApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

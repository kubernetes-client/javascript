...
/**
* Policy service.
* @module io.kubernetes.client/io.kubernetes.client.apis/PolicyApi
...
export default class PolicyApi {
    ...
    * @alias module:io.kubernetes.client/io.kubernetes.client.apis/PolicyApi
    * @class
    ...
    */
     ...
     * @callback module:io.kubernetes.client/io.kubernetes.client.apis/PolicyApi~getAPIGroupCallback
     ...
     * @param {module:io.kubernetes.client/io.kubernetes.client.apis/PolicyApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
